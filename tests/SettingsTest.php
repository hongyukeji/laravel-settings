...
class SettingsTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testHasReturnRepositoryValue()
    {
        ...
        $settings = new \Hongyukeji\LaravelSettings\Settings($mock, $g, $valueSerializer);
    ...
    {
        $context1 = new \Hongyukeji\LaravelSettings\Context();

        $context2 = new \Hongyukeji\LaravelSettings\Context();
    ...
    {
        return m::mock('Hongyukeji\LaravelSettings\Contracts\Repository');
    }
    ...
    {
        return m::mock('Hongyukeji\LaravelSettings\Contracts\KeyGenerator');
    }

    protected function getValueSerializerMock()
    {
        return m::mock('Hongyukeji\LaravelSettings\Contracts\ValueSerializer');
    }
}
